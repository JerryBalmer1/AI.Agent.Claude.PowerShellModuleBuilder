...
param([string]$RunDir = "$PSScriptRoot/../../runs/005-plugin-on")
Describe 'Run 005 is complete' {
    ...
    It 'records a distinct session identifier' {
        $r | Should -Match 'session-identifier:\s*\S+'
        $r | Should -Not -Match 'session-identifier:\s*b0a48c69-0c6c-4c8e-8d6c-2998ea9f76db' }
